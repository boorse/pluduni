...
import { loadAll, subscribe, allSpecies, allPlayers, allCats, splitInds, promote, demote,
         namedOf, getMe, setMe, isReady } from './store.js'
import { IdentityPicker, SpeciesEditor, ObservationEditor } from './editui.jsx'
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#EDE7D8' }}>
      <div style={{ position:'relative', height: wide?'58vh':'46vh', minHeight:320,
        ...
        <PhotoBg target="site:hero" fallback="linear-gradient(155deg,#22301C 0%,#3E5233 42%,#6E8557 78%,#94A874 100%)" />
          ...
          <div style={{ padding:'14px 18px 22px' }}>
            ...
            {detTab==='obs' && <>
              <div style={{ display:'flex', alignItems:'center', marginBottom:8 }}>
                ...
                {edit && <button onClick={()=>setObsEditor(sp)} style={{ marginLeft:'auto', fontSize:11,
